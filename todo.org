...
Also invars don't need to be constrained by an archetype set, so they probably should not
count for ~VAR_COUNT~ in the same way.
I might need to diffentiate here.
** TODO anyvars
